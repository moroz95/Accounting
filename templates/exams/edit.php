...
<form action="/exam/edit/<?= $exam_id ?>" method="POST" class="form-horizontal col-md-12">
    <div class="form-group">
        <label for="examName" class="col-md-3 control-label">Название экзамена</label>
        <div class="col-md-6">
            <input type="text" class="form-control" name="examName" id="examName"  value= <?= $exam_data['exam_title']?> >
        </div>
        <br>
        <br>
        ...
        <div class="col-md-6">
            <input type="text" class="form-control" name="examTeacher" id="examTeacher" placeholder="Введите ФИО преподавателя" value= <?= $exam_data['exam_teacher']?> >
        </div>
        <br>
        <br>
        <label for="examDate" class="col-md-3 control-label">Дата экзамена</label>
        <div class="col-md-6">
            <input type="date" class="form-control" name="examDate" id="examDate" required  value= <?= $exam_data['exam_date']?> >
        </div>
        <br>
        <br>
        <br>
